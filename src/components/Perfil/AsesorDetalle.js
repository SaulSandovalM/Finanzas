...
import {Container, Content, Card, Right, Icon} from 'native-base';
...
const CONTENT = [
  {
    nombre: 'Nombre de Cliente: Saul Sandoval M',
...
class AsesorDetalle extends Component {
  state = {
    activeSection: false,
    collapsed: true
  };
  ...
  render() {
    return (
      <Container style={styles.container}>
        <Content>
          <CabeceraPer headerText="CLIENTES"/>
